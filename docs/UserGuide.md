...
- **Connections**
    ...
    Якщо кількість з'єднань з помилками росте дуже швидко, або майже дорівнює кількості вдалих з'єднань - це свідчить 
...
- **Status Code Distribution**
    ...
    детальніше можна почитати на [Wikipedia](https://uk.wikipedia.org/wiki/Список_кодів_стану_HTTP).
