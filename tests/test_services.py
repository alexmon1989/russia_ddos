...
class DescribeServices:
    ...
    def it_checks_successful_tcp_attack(self):
        ...
        uuid = CheckTcpAttackError(message=NO_SUCCESSFUL_CONNECTIONS_VPN_ERR_MSG).uuid
    ...
    def it_checks_successful_connections(self):
        ...
        context.target.statistic.start_time = None
        uuid = CheckConnectionError(message=no_successful_connections_error_msg(context)).uuid
